...
$routes->get('/ambilantrian', 'AmbilAntrian::index');
$routes->add('ambilantrian/ambil', 'AmbilAntrian::ambil');

$routes->get('/tampilantrian', 'TampilAntrian::index');

$routes->get('/kelolaantrian', 'KelolaAntrian::index');
